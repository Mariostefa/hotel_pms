...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO xrhsh_yphresias VALUES ('$afm','$service_id','$service_use_date','$service_price',
                                                  ,'$date_of_transaction','$state_of_transaction','$payment_method')";
...
<body>
    ...
    <div class="form">
        <form method="post">
            ...
            <label for="service-use-date">ΗΜ. ΧΡΗΣΗΣ ΥΠΗΡΕΣΙΑΣ(Ετος/μήνας/ήμερα) </label>
            <input id="service-use-date" name="service-use-date" type="text">
            <label for="price">ΠΟΣΟ</label>
            <input id="price" name="price" type="number" step="0.01">
            <label for="date-of-transaction">ΗΜ. ΣΥΝΑΛΛΑΓΗΣ</label>
            <input id="date-of-transaction" name="date-of-transaction" type="text">
